...
$s.Speak("You have been hacked by Unknown Black hat.")
$s.Speak("I own your laptop and i now have access to all your passwords, files, photos, data, ecetera.")
$s.Speak("We are free")
$s.Speak("We are one")
$s.Speak("We are Fuck Society!")
$s.Speak("Expect us!")
